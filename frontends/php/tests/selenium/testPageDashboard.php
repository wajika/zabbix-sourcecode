...
class testPageDashboard extends CWebTest {
	...
	public function testPageDashboard_EnableConfigurationAndCancel() {
		...
		$this->zbxTestAssertElementPresentXpath("//input[@id='extAck_0'][@disabled]");
		$this->zbxTestAssertElementPresentXpath("//input[@id='extAck_1'][@disabled]");
		$this->zbxTestAssertElementPresentXpath("//input[@id='extAck_2'][@disabled]");
		...
		$this->zbxTestAssertElementNotPresentXpath("//input[@id='extAck_0'][@disabled]");
		$this->zbxTestAssertElementNotPresentXpath("//input[@id='extAck_1'][@disabled]");
		$this->zbxTestAssertElementNotPresentXpath("//input[@id='extAck_2'][@disabled]");
	...
	public function testPageDashboard_Configuration() {
		...
		$this->zbxTestClickXpath("//ul[@id='extAck']//label[@for='extAck_1']");
