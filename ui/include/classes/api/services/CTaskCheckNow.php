 ...
 */
class CTaskCheckNow extends CApiService {
	 ...
	 * @return array
	 */
	public function create(array $task, string $path) {
		$this->validateCreate($task, $path);
	 ...
	 */
	protected function validateCreate(array &$task, string $path) {
